...
<body>
  <div id="loginScreen" class="login-screen">
    <div class="login-card">
      ...
      <h1>KSP • POLICJA</h1>
      <p class="subtitle">
        Wewnętrzny system CAD/MDT dla policyjnej grupy roleplay na serwerze ER:LC.
  ...
  <div id="app" class="app hidden">
    <aside id="sidebar" class="sidebar">
      ...
      <div style="margin:0 4px;padding:9px 11px;border-radius:10px;background:rgba(47,140,255,.07);border:1px solid rgba(103,178,255,.16);font-size:10px;font-weight:850;letter-spacing:1.4px;color:#9bcfff;text-align:center">ER:LC • CAD / MDT • SYSTEM RP</div>
      ...
      <nav class="nav" id="navigation">
        ...
        <button class="nav-button" data-page="cad">
          <span class="nav-icon">⌖</span> CAD / aktywne patrole
        </button>
...
app.get('/health', (req, res) => {
  res.json({ ok: true, service: 'KSP CAD/MDT RP', time: new Date().toISOString() });
});
